	...
	return (
		<MainLayout>
			<section className="pb-24 px-6 md:px-48">
				...
				<p className="mt-4 md:mt-12 mb-12 md:mb-24 text-sm md:text-lg text-brown text-center">Nuestros proyectos son personalizados y a la medida <br className="hidden md:block" /> de nuestros clientes.</p>
				<div className="grid grid-cols-1 md:grid-cols-4 space-y-12 md:space-y-0 space-x-0 md:space-x-12 relative">
					<div className="flex flex-col text-center space-y-4 p-6 rounded-2xl bg-brownlight relative step-card">
						...
						<p className="text-sm text-brown">Nuestro equipo ayudará a definir el problema y desarrollar una solución, con un presupuesto claro, en un modelo de colaboración y bajo recomendaciones técnicas. <br /><br />Trazamos objetivos y plazos.</p>
					</div>
					<div className="flex flex-col text-center space-y-4 p-6 rounded-2xl bg-brownlight relative step-card">
						...
						<p className="text-sm text-brown">Creamos un equipo contigo para comenzar a diseñar una solución, creando un roadmap de trabajo, objetivos de diseño y desarrollo. <br /><br />Investigación del proyecto.</p>
					</div>
					<div className="flex flex-col text-center space-y-4 p-6 rounded-2xl bg-brownlight relative step-card">
						...
						<p className="text-sm text-brown">Nuestro equipo comenzará a desarrollar la solución, siguiendo de trabajo y entregando los objetivos. <br /><br /> Reuniones de seguimiento semanal.</p>
					</div>
					<div className="flex flex-col text-center space-y-4 p-6 rounded-2xl bg-brownlight relative step-card">
						...
						<p className="text-sm text-brown">Mantenemos una garantía de 3 meses en todos nuestros proyectos además nos adaptamos a tus necesidades, con cobertura desde el desarrollo de características adicionales, reaparaciones urgentes y cubrir el mantenimiento continuo.</p>
					</div>
				</div>
			</section>
			...
			<section className="pb-16 px-6 md:px-24 flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 space-x-0 md:space-x-24">
				<button className="background-image-6 text-center text-lg md:text-xl text-brown w-full" style={{ fontWeight: 600 }}
				 onClick={() => navigate("/projects")}>
					Nuestros proyectos
				</button>
				<button className="background-image-5 text-center text-lg md:text-xl text-brown w-full" style={{ fontWeight: 600 }}
				onClick={() => navigate("/projects")}>
					Aprendamos juntos
				</button>
			</section>
