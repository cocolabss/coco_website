...
const Information: React.FC<InformationProps> = ({ showTitle }) => {
	return (
		<>
			<div className="pb-24 md:pb-20 px-6 md:px-24 text-center">
				{showTitle && (
					<h2
						className="relative background-image-1 text-2xl md:text-4xl text-brown top-[-20px]"
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 text-lg md:text-2xl text-brown">
					<div className="p-6">
